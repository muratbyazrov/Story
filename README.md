...
### Rmq Adapter
Прежде всего надо сказать, что этот модуль поддерживает минимум параметров. RabbitMQ довольна сложная технология с большим
количеством настроек и прочих нюансов. Если надо добавить какую-то функциональность, прошу создать mergeRequest и я обязательно
посмотрю и внесу изменения. 
