...
Рассмотрим файловую структуру проекта на примере приложения cats-application
...
|            |
|            |__cats-controller.js (Валидирует и предобратывает запросы. См ниже пример)
...
- Выполняет первичную валидацию запроса
